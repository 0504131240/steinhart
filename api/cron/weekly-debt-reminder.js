...
function debtEmailContent(famName, debts, totalDebt, creditOffset) {
  ...
  const html = `<!DOCTYPE html><html dir="rtl" lang="he"><head><meta charset="utf-8"></head><body style="margin:0;padding:12px;background:#eef0f8;font-family:-apple-system,Helvetica,Arial,sans-serif;direction:rtl">
    ...
    <tr><td style="background:linear-gradient(135deg,#0C447C,#1E88D8);padding:20px;text-align:center">
      <div style="font-size:28px">📋</div><div style="color:#fff;font-size:17px;font-weight:700">תזכורת שבועית · Steinhart</div>
    </td></tr>
      ...
      if (tokenDocs.length) {
        ...
        const resp = await getMessaging().sendEachForMulticast({
          ...
          data: {
            ...
            icon: 'https://steinhart-livid.vercel.app/icon-192.png',
            link: 'https://steinhart-livid.vercel.app/',
          },
        });
